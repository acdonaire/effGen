...
See the [multimodal overview](https://github.com/ctrl-gaurav/effGen/blob/main/docs/multimodal/overview.md) and the [cookbook index](https://github.com/ctrl-gaurav/effGen/blob/main/docs/cookbook/README.md).
