...
cosign verify-blob \
    --certificate-identity "https://github.com/ctrl-gaurav/effGen/.github/workflows/release.yml@refs/tags/v0.2.10" \
    --certificate-oidc-issuer "https://token.actions.githubusercontent.com" \
    --bundle effgen-0.2.10.whl.sigstore.bundle \
    effgen-0.2.10-py3-none-any.whl
```
